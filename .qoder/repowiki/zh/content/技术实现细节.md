...
## 更新摘要
**变更内容**
- 新增AI新闻RSS聚合系统，支持TechCrunch AI和机器之心等多源新闻聚合
- 建立统一的API共享层，包含CORS中间件和标准化响应格式
- 完善组件化架构，包含主题系统、标签栏和AI新闻展示组件
- 实现智能去重和时间排序机制，优化新闻数据处理流程
- 集成响应式设计和暗色模式支持，提升用户体验
...
**更新** 项目已从简单的HTML布局演示升级为完整的Next.js应用，具备RSS聚合、主题系统、组件化架构等企业级功能。新增的AI新闻RSS聚合系统支持多源新闻数据聚合，提供智能化的内容展示和交互体验。
...
- [lib/rss.ts:27-44](file://lib/rss.ts#L27-L44)
...
**图表来源**
- [components/ai-news/NewsFeed.tsx:1-35](file://components/ai-news/NewsFeed.tsx#L1-L35)
- [components/ai-news/NewsHeadline.tsx:1-57](file://components/ai-news/NewsHeadline.tsx#L1-L57)
- [components/ai-news/NewsListItem.tsx:1-50](file://components/ai-news/NewsListItem.tsx#L1-L50)
...
```mermaid
flowchart TD
START[开始解析] --> PARSE_CONFIG[读取RSS配置]
...
**图表来源**
- [lib/rss.ts:27-70](file://lib/rss.ts#L27-L70)
...
1. **AI新闻RSS聚合系统**：实现了高效的多源并行抓取和智能数据处理，支持TechCrunch AI和机器之心等RSS源
